...
class Q {
  ...
  start(e, r) {
    const s = e.renderer;
    s.shader.bind(this._shader, this._didUpload), s.shader.updateUniformGroup(s.globalUniforms.uniformGroup), s.geometry.bind(r, this._shader.glProgram);
  }
  execute(e, r) {
    const s = e.renderer;
...
var g = /* @__PURE__ */ ((t) => (t[t.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER", t[t.ARRAY_BUFFER = 34962] = "ARRAY_BUFFER", t[t.UNIFORM_BUFFER = 35345] = "UNIFORM_BUFFER", t))(g || {});
class He {
  constructor(e, r) {
...
class J {
   ...
   */
  constructor(e) {
    this._gpuBuffers = /* @__PURE__ */ Object.create(null), this._boundBufferBases = /* @__PURE__ */ Object.create(null), this._renderer = e;
  }
  /**
   * @ignore
   */
  ...
  updateBuffer(e) {
    ...
    if (s.byteLength >= e.data.byteLength)
      ...
      const i = e.descriptor.usage & T.STATIC ? r.STATIC_DRAW : r.DYNAMIC_DRAW;
  ...
  createGLBuffer(e) {
    const { _gl: r } = this;
    let s = g.ARRAY_BUFFER;
    e.descriptor.usage & T.INDEX ? s = g.ELEMENT_ARRAY_BUFFER : e.descriptor.usage & T.UNIFORM && (s = g.UNIFORM_BUFFER);
    const n = new He(r.createBuffer(), s);
...
const P = class ee {
  ...
  init(e) {
    if (e = { ...ee.defaultOptions, ...e }, e.context)
      this.initFromContext(e.context);
    else {
      const r = this._renderer.background.alpha < 1, s = e.premultipliedAlpha ?? !0, n = e.antialias && !this._renderer.backBuffer.useBackBuffer;
   ...
   */
  initFromContext(e) {
    this.gl = e, this.webGLVersion = e instanceof WebGL2RenderingContext ? 2 : 1, this.getExtensions(), this.validateContext(e), this._renderer.runners.contextChange.emit(e);
  ...
  getExtensions() {
    ...
    this.webGLVersion === 1 ? this.extensions = {
      ...r,
...
class re {
  /** @param renderer - The renderer this System works for. */
  constructor(e) {
    this._geometryVaoHash = /* @__PURE__ */ Object.create(null), this._renderer = e, this._activeGeometry = null, this._activeVao = null, this.hasVao = !0, this.hasInstance = !0;
  }
  /** Sets up the renderer context and necessary buffers. */
  contextChange() {
  ...
  activateVao(e, r) {
    ...
    let a = null;
    for (const o in i) {
      const c = i[o], u = c.buffer, _ = n.getGlBuffer(u);
      if (r._attributeData[o]) {
        a !== _ && (n.bind(u), a = _);
        const h = c.location;
        s.enableVertexAttribArray(h);
        const d = z(c.format);
        if (s.vertexAttribPointer(
          h,
          d.size,
          ke(c.format),
          d.normalised,
   ...
   */
  draw(e, r, s, n) {
    const { gl: i } = this._renderer, a = this._activeGeometry, o = Ve[a.topology || e];
...
const Xe = new ve({
  ...
  init(e = {}) {
    ...
    this.useBackBuffer = r, this._antialias = s, this._renderer.context.supports.msaa || (m("antialiasing, is not supported on when using the back buffer"), this._antialias = !1), this._state = y.for2d();
    const n = new Ie({
      vertex: `
    ...
    this._bigTriangleShader = new R({
      glProgram: n,
      resources: {
        uTexture: E.WHITE.source
      }
    });
  }
  /**
  ...
  _getBackBufferTexture(e) {
    return this._backBufferTexture = this._backBufferTexture || new E({
      source: new j({
        width: e.width,
        height: e.height,
...
class ae {
  ...
  setStencilMode(e, r) {
    ...
    if (s.stencilMode = e, s.stencilReference = r, e === v.DISABLED) {
...
function $e(t, e) {
  const r = Math.max(oe[t.data.type] / 16, 1), s = t.data.value.length / t.data.size, n = (4 - s % 4) % 4;
  return `
        v = uv.${t.data.name};
        offset += ${e};
...
class Ye {
  ...
  initGpuRenderTarget(e) {
    const s = this._renderer.gl, n = new je();
    return xe.test(e.colorTexture.resource) ? (n.framebuffer = null, n) : (this._initColor(e, n), s.bindFramebuffer(s.FRAMEBUFFER, null), n);
  }
  clear(e, r, s) {
    if (!r)
      return;
    const n = this._renderTargetSystem;
    typeof r == "boolean" && (r = r ? x.ALL : x.NONE);
  ...
  for (const u in t.groups) {
    ...
    for (const h in _.resources) {
      ...
      if (d instanceof U)
        ...
        const Te = t._uniformBindMap[u][h], F = o.uniformData[Te];
        F && (n || (n = !0, s.push(`
                        var tS = r.texture;
                        `)), e._gl.uniform1i(F.location, a), r.push(`
...
function nt(t, e) {
  const r = H(t, t.VERTEX_SHADER, e.vertex), s = H(t, t.FRAGMENT_SHADER, e.fragment), n = t.createProgram();
  ...
  )), t.linkProgram(n), t.getProgramParameter(n, t.LINK_STATUS) || st(t, n, r, s), e._attributeData = et(
    n,
    t,
    !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex)
  ), e._uniformData = rt(n, t), e._uniformBlockData = tt(n, t), t.deleteShader(r), t.deleteShader(s);
  const a = {};
...
class he {
  constructor(e) {
    this._activeProgram = null, this._programDataHash = /* @__PURE__ */ Object.create(null), this._nextIndex = 0, this._boundUniformsIdsToIndexHash = /* @__PURE__ */ Object.create(null), this._boundIndexToUniformsHash = /* @__PURE__ */ Object.create(null), this._shaderSyncFunctions = /* @__PURE__ */ Object.create(null), this._renderer = e;
  }
  contextChange(e) {
    this._gl = e, this._maxBindings = e.MAX_UNIFORM_BUFFER_BINDINGS ? e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS) : 0, this._programDataHash = /* @__PURE__ */ Object.create(null), this._boundUniformsIdsToIndexHash = /* @__PURE__ */ Object.create(null), this._boundIndexToUniformsHash = /* @__PURE__ */ Object.create(null), this._activeProgram = null;
  }
  /**
  ...
  bind(e, r) {
    if (this._setProgram(e.glProgram), r)
      return;
    S.textureCount = 0, S.blockIndex = 0;
    let s = this._shaderSyncFunctions[e.glProgram._key];
    s || (s = this._shaderSyncFunctions[e.glProgram._key] = this._generateShaderSync(e, this)), s(this._renderer, e, S);
  }
  /**
  ...
  updateUniformGroup(e) {
    this._renderer.uniformGroup.updateUniformGroup(e, this._activeProgram, S);
  }
  /**
  ...
  _createProgramData(e) {
    const r = e._key;
    return this._programDataHash[r] = nt(this._gl, e), this._programDataHash[r];
  }
  destroy() {
  ...
  for (const s in t.uniforms) {
    ...
    for (let a = 0; a < A.length; a++) {
      ...
      if (n.type === o.type && o.test(n)) {
        r.push(`name = "${s}";`, A[a].uniform), i = !0;
        break;
      }
    }
    if (!i) {
      const o = (n.size === 1 ? it : at)[n.type].replace("location", `ud["${s}"].location`);
      r.push(`
            cu = ud["${s}"];
            cv = cu.value;
            v = uv["${s}"];
...
function ct(t) {
  const e = {};
  return e.normal = [t.ONE, t.ONE_MINUS_SRC_ALPHA], e.add = [t.ONE, t.ONE], e.multiply = [t.DST_COLOR, t.ONE_MINUS_SRC_ALPHA, t.ONE, t.ONE_MINUS_SRC_ALPHA], e.screen = [t.ONE, t.ONE_MINUS_SRC_COLOR, t.ONE, t.ONE_MINUS_SRC_ALPHA], e.none = [0, 0], e["normal-npm"] = [t.SRC_ALPHA, t.ONE_MINUS_SRC_ALPHA, t.ONE, t.ONE_MINUS_SRC_ALPHA], e["add-npm"] = [t.SRC_ALPHA, t.ONE, t.ONE, t.ONE], e["screen-npm"] = [t.SRC_ALPHA, t.ONE_MINUS_SRC_COLOR, t.ONE, t.ONE_MINUS_SRC_ALPHA], e.erase = [t.ZERO, t.ONE_MINUS_SRC_ALPHA], e;
}
const ut = 0, _t = 1, ft = 2, ht = 3, lt = 4, dt = 5, de = class D {
  constructor() {
    this.gl = null, this.stateId = 0, this.polygonOffset = 0, this.blendMode = "none", this._blendEq = !1, this.map = [], this.map[ut] = this.setBlend, this.map[_t] = this.setOffset, this.map[ft] = this.setCullFace, this.map[ht] = this.setDepthTest, this.map[lt] = this.setFrontFace, this.map[dt] = this.setDepthMask, this.checks = [], this.defaultState = y.for2d();
  }
  contextChange(e) {
    this.gl = e, this.blendModesMap = ct(e), this.reset();
  }
  /**
...
class Et {
  constructor(e) {
    this.target = te.TEXTURE_2D, this.texture = e, this.width = -1, this.height = -1, this.type = f.UNSIGNED_BYTE, this.internalFormat = I.RGBA, this.format = I.RGBA, this.samplerType = 0;
  }
}
const bt = {
  id: "image",
...
function X(t, e, r, s, n, i, a) {
  const o = i, c = N[a ? "clamp-to-edge" : t.addressModeU], u = N[a ? "clamp-to-edge" : t.addressModeV], _ = N[a ? "clamp-to-edge" : t.addressModeW];
  if (e[n](o, e.TEXTURE_WRAP_S, c), e[n](o, e.TEXTURE_WRAP_T, u), e.TEXTURE_WRAP_R && e[n](o, e.TEXTURE_WRAP_R, _), e[n](o, e.TEXTURE_MAG_FILTER, V[t.magFilter]), r) {
    const h = Rt[t.minFilter][t.mipmapFilter];
    e[n](o, e.TEXTURE_MIN_FILTER, h);
  } else
    e[n](o, e.TEXTURE_MIN_FILTER, V[t.minFilter]);
  if (s && t.maxAnisotropy > 1) {
    const h = Math.min(t.maxAnisotropy, e.getParameter(s.MAX_TEXTURE_MAX_ANISOTROPY_EXT));
    e[n](o, s.TEXTURE_MAX_ANISOTROPY_EXT, h);
  }
  t.compare && e[n](o, e.TEXTURE_COMPARE_FUNC, Tt[t.compare]);
}
function vt(t) {
  return {
    // 8-bit formats
...
function xt(t, e) {
  let r = {}, s = t.RGBA;
  return t instanceof WebGL2RenderingContext ? (r = {
...
class Ee {
  constructor(e) {
    this.managedTextures = [], this._glTextures = /* @__PURE__ */ Object.create(null), this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundTextures = [], this._activeTextureLocation = -1, this._boundSamplers = /* @__PURE__ */ Object.create(null), this._uploads = {
      ...
      video: pt,
      compressed: gt
    }, this._useSeparateSamplers = !1, this._renderer = e;
  }
  contextChange(e) {
    this._gl = e, this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = xt(e, this._renderer.context.extensions), this._mapFormatToType = At(e), this._mapFormatToFormat = vt(e)), this._glTextures = /* @__PURE__ */ Object.create(null), this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundSamplers = /* @__PURE__ */ Object.create(null);
    for (let r = 0; r < 16; r++)
      this.bind(E.EMPTY, r);
  }
  initSource(e) {
  ...
  bindSource(e, r = 0) {
    ...
    if (e._touched = this._renderer.textureGC.count, this._boundTextures[r] !== e) {
      this._boundTextures[r] = e, this._activateLocation(r), e = e || E.EMPTY.source;
  ...
  _initSource(e) {
    const r = this._gl, s = new Et(r.createTexture());
  ...
  _initSampler(e) {
    ...
    return this._glSamplers[e._resourceId] = s, X(
      e,
      r,
  ...
  generateCanvas(e) {
    const { pixels: r, width: s, height: n } = this.getPixels(e), i = Ae.get().createCanvas();
  ...
  getPixels(e) {
    const r = e.source.resolution, s = e.frame, n = Math.max(Math.round(s.width * r), 1), i = Math.max(Math.round(s.height * r), 1), a = new Uint8Array(Bt * n * i), o = this._renderer, c = o.renderTarget.getRenderTarget(e), u = o.renderTarget.getGpuRenderTarget(c), _ = o.gl;
...
class be {
  init() {
    const e = new U({
      ...
      uTransformMatrix: { value: new Be(), type: "mat3x3<f32>" },
  ...
  execute(e, r) {
    ...
    n.groups[0] = i.globalUniforms.bindGroup, i.shader.bind(n), i.geometry.bind(o, n.glProgram);
...
class Se {
  ...
  execute(e, r) {
    ...
    if (n) {
      ...
      n = this._shader;
      const i = r.texture.source;
      n.resources.uTexture = i, n.resources.uSampler = i.style;
    }
...
const Nt = [
  ...
  ae,
  ne
], It = [...Le], Dt = [Q, Se, be], ge = [], pe = [], Re = [];
p.handleByNamedList(l.WebGLSystem, ge);
p.handleByNamedList(l.WebGLPipes, pe);
p.handleByNamedList(l.WebGLPipesAdaptor, Re);
p.add(...Nt, ...It, ...Dt);
class Pt extends Ne {
  constructor() {
    const e = {
