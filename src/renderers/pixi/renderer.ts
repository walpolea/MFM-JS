...
import { Sprite, ParticleContainer, Application, Texture, Point, Container, Rectangle, InteractionEvent, ObservablePoint } from "pixi.js";
...
export class PixiRenderer implements IRenderer {
  ...
  initializePIXI() {
    this.particleContainer = new ParticleContainer(this.totalSites, { tint: true });
  ...
  initializeClickArea() {
    ...
    this.clickArea.on("pointerdown", (e: InteractionEvent) => {
      this.pointerDown = true;
      this.handleClick(e);
    });

    this.clickArea.on("pointerup", (e: InteractionEvent) => {
  ...
  handleClick(e: InteractionEvent) {
    if (this.mouseEnabled && this.pointerDown && e.target) {
      let p: Point = e.data.getLocalPosition(this.pixiApplication.stage);
