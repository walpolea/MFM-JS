...
export class Builders {
  ...
  static DLINE_SL_NE = ExpertBuilder.CREATOR([SwapLine.CREATE_NORTHWEST, [SPLAT.MAP_E, SPLAT.MAP_N, SPLAT.MAP_E, SPLAT.MAP_N]]);
  static DLINE_SL_NW = ExpertBuilder.CREATOR([SwapLine.CREATE_NORTHEAST, [SPLAT.MAP_W, SPLAT.MAP_S, SPLAT.MAP_W, SPLAT.MAP_S]]);
  static DLINE_SL_SE = ExpertBuilder.CREATOR([SwapLine.CREATE_SOUTHWEST, Splatish.DLINE_SE, Symmetries.NORMAL]);
  static DLINE_SL_SW = ExpertBuilder.CREATOR([SwapLine.CREATE_SOUTHEAST, [SPLAT.MAP_E, SPLAT.MAP_N, SPLAT.MAP_E, SPLAT.MAP_N]]);
}
